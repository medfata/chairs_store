...
export default function HomePageContent() {
  ...
  useEffect(() => {
    const loadProducts = async () => {
      ...
      try {
        ...
        // For homepage, we'll just select the first 3 products for the carousel
        // In a real app, you might want to add a 'featured' field in your spreadsheet
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setActiveSlide((prev) => (prev + 1) % (featuredProducts.length || 3));
    }, 5000);
        ...
        <div className="section-container">
          <div className="flex justify-between items-center mb-12">
            ...
            <div className="flex space-x-2">
              {isLoading ? (
                <div className="animate-pulse w-20 h-3 bg-gray-300 rounded-full"></div>
              ) : (
            ...
            {isLoading ? (
              ...
              >
                {featuredProducts.length > 0 ? (
                    ...
                    <div key={idx} className="min-w-full p-4">
                      <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
                        ...
                        <div className="p-8">
                          ...
                          <p className="text-xl font-bold text-black mb-4">MAD {product.price.toFixed(2)}</p>
                          <Link 
                            href="/products" 
                  ...
                  [
                    { name: "Modern Office Chair", price: 1200, image: "/images/single_chairs/Chaise de Bureau Ergonomique  Accoudoirs 3D.jpeg", collection: "single_chairs" as const },
                    { name: "Elegant Chair Pack", price: 3500, image: "/images/pack_of_chairs/Noir.jpeg", collection: "pack_of_chairs" as const },
                    { name: "Premium Ergonomic Chair", price: 1800, image: "/images/single_chairs/Chaise de Bureau Ergonomique  Accoudoirs 3D.jpeg", collection: "single_chairs" as const }
                  ].map((product, idx) => (
                    <div key={idx} className="min-w-full p-4">
                      <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
